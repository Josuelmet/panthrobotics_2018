...
public class RobotMap
{
	...
	public final static int lEFT_BACK_TALON_SRX_CAN_DEVICE_ID = 7;
	public final static int RIGHT_FRONT_TALON_SRX_CAN_DEVICE_ID = 4;
	public final static int RIGHT_BACK_TALON_SRX_CAN_DEVICE_ID = 2;
	public final static int SWERVE_WHEEL_CAN_DEVICE_ID = 0; //UNKNOWN
